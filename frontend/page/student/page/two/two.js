...
Page({
  ...
  data: {
    ...
    index:0,//选择的下拉列表下标
    startdate: '2020-06-17', //开始时间
    enddate:'2020-06-17',    //结束时间
    time: '12:00',
    dateTimeArray: null,
    dateTime: null,
    dateTimeArray1: null,
    ...
    day: '三',
    nowDate: '2020-06-17',
    school:['请先选择院系','计算机学院','通信学院','艺术与设计学院','数学学院','电力工程学院'],
    s1index:0,
    s2index:0,
    t1: [''],
    t2:[''],
  ...
  s1PickerSelected:function(e){
    ...
    wx.request({
      url: "http://127.0.0.1:8080/teacher/search_id",
      header: {
